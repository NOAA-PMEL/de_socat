...
def get_socat_subset(ll_longitude, ur_longitude, ll_latitude, ur_latitude):
    # DEBUG print('Starting coordinate constraint processing...')
    lon_con = ''
