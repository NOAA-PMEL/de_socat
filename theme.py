theme = {
    ...
    "footer_background_color":"#34327F",
    ...
    "header_text":"#333333",
    "heading_text":"#333333",
    "hero_background_color":"#C6C4FF",
    "hero_title_text":"#0C0C1C",
    "hero_subtitle_text":"#333333",
    "hero_controls_background_color":"rgba(242, 241, 255, 0.9)",
    "hero_controls_label_text":"#333333",
    "hero_controls_label_font_size":"14px",
    "hero_controls_grid_columns":4,
    "hero_controls_accent":"#C6C4FF",
    "hero_border":{
        "width":"0",
        "style":"solid",
        "color":"transparent"
...
# These are defined and used in the layout, but they don't actually work,
# as is the case with most of the tab styles.
...
second_tab_selected_style = {
    'border-top-left-radius': '8px',   # Rounded top-left corner
    'border-top-right-radius': '8px',  # Rounded top-right corner
    'border-left': '2px solid #007bff',     # Distinct green outline (thicker)
    'border-right': '2px solid #007bff',     # Distinct green outline (thicker)
    'border-top': '2px solid #007bff',     # Distinct green outline (thicker)
    'border-bottom': 'none',           # Remove the bottom border
    'background-color': 'blue!important',     # set background for the selected tab (to stand out)
    'padding': '10px 15px',
    'margin-right': '5px',
    'color': '#007bff',                # Blue text color
    'font-weight': 'bold',             # Bold text for selected tab
